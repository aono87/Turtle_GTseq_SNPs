...
# --- Input Paths ---
sam_path <- "data-raw/sam_files/final_sams/" #updated this to where the final sam files were (originals and merged)
...
pass1.manual.loci.to.remove <- c("locus019", "locus016")
